...
public final class developerStatistics_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                                <div class=\"row\">\r\n");
      out.write("                                    <div class=\"col-md-9\"><h4>开发人员统计</h4></div>\r\n");
      ...
      out.write("                                    </thead>\r\n");
      out.write("                                    <tbody>\r\n");
      out.write("                                    <tr v-for=\"(developer,index) in developers\">\r\n");
      out.write("                                        <td>{{index+1}}</td>\r\n");
      out.write("                                        <td>{{developer.username}}</td>\r\n");
      out.write("                                        <td>{{developer.designate}}</td>\r\n");
      out.write("                                        <td>{{developer.processing}}</td>\r\n");
      out.write("                                        <td>{{developer.checking}}</td>\r\n");
      out.write("                                        <td>{{developer.finished}}</td>\r\n");
      out.write("                                        <td>{{developer.bugNumber}}</td>\r\n");
      out.write("                                    </tr>\r\n");
      out.write("                                    </tbody>\r\n");
      out.write("\r\n");
      out.write("\r\n");
      ...
      out.write("            axios\r\n");
      out.write("                .post(\"/statistics/developerStatistics\")\r\n");
      out.write("                .then(function (response) {\r\n");
      out.write("                    vm.developers = response.data;\r\n");
      out.write("                });\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("        },\r\n");
      ...
      out.write("                window.location.href=\"/statistics/exportExcelDevloper\";\r\n");
      out.write("            }\r\n");
      out.write("        }\r\n");
      out.write("    })\r\n");
