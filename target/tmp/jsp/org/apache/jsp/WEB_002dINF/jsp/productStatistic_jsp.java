...
public final class productStatistic_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                                <div class=\"row\">\r\n");
      out.write("                                    <div class=\"col-md-9\"><h4>产品统计</h4></div>\r\n");
      out.write("                                    <div class=\"col-md-2\">\r\n");
      out.write("                                        <button class=\"btn btn-block btn-outline-warning\" type=\"button\" data-toggle=\"modal\" data-target=\"#updateProductModal\"\r\n");
      ...
      out.write("                                    <template v-for=\"product in products\">\r\n");
      out.write("                                        <thead>\r\n");
      out.write("                                        <tr>\r\n");
      out.write("                                            <th colspan=\"4\"><h4><b style=\"color: red;\">{{product.productName}}</b></h4></th>\r\n");
      out.write("                                        </tr>\r\n");
      out.write("                                        <tr>\r\n");
      out.write("                                            <th scope=\"col\">序号</th>\r\n");
      out.write("                                            <th scope=\"col\">项目名</th>\r\n");
      out.write("                                            <th scope=\"col\">未完成Bug量</th>\r\n");
      out.write("                                            <th scope=\"col\">Bug总量</th>\r\n");
      out.write("                                            <th scope=\"col\">完成状态</th>\r\n");
      out.write("                                        </tr>\r\n");
      out.write("                                        </thead>\r\n");
      out.write("                                        <tbody>\r\n");
      out.write("\r\n");
      out.write("                                        <tr v-if=\"product.projects.length == 0\"><td colspan=\"4\" class=\"text-center\">无项目</td></tr>\r\n");
      out.write("                                        <tr v-else v-for=\"(project,index) in product.projects\">\r\n");
      out.write("                                            <td>{{index+1}}</td>\r\n");
      out.write("                                            <td>{{project.projectName}}</td>\r\n");
      out.write("                                            <td>{{project.bugNumber}}</td>\r\n");
      out.write("                                            <td>{{project.allBug}}</td>\r\n");
      out.write("                                            <td>{{project.finished?\"已完成\":\"未完成\"}}</td>\r\n");
      out.write("                                        </tr>\r\n");
      out.write("                                        </tbody>\r\n");
      out.write("                                    </template>\r\n");
      out.write("\r\n");
      ...
      out.write("            axios\r\n");
      out.write("                .post(\"/statistic/productStatistic\")\r\n");
      ...
      out.write("                window.location.href=\"/statistic/exportExcelProduct\";\r\n");
      out.write("            }\r\n");
      out.write("        }\r\n");
      out.write("    })\r\n");
